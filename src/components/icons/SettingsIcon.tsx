...
const fill2 = { fill: '#fff' };
const fill3 = { fill: '#58b1cb' };
const fill4 = { fill: '#bae4f0' };
const fill5 = { fill: '#abd9e2' };
...
const SettingsIcon = ({ width = 76.7, height = 83 }) => (
  <Svg viewBox="0 0 76.7 83" width={width} height={height}>
    <G>
      ...
      />
      <Circle {...fill2} cx={59.5} cy={10.8} r={8.3} />
      <Path
        {...fill3}
      ...
      />
      <Circle {...fill2} cx={59.5} cy={72.3} r={8.3} />
      <Path
        {...fill3}
      ...
      />
      <Circle {...fill2} cx={17.3} cy={42.3} r={8.3} />
      <Path
        {...fill3}
