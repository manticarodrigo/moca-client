...
const SvgComponent = () => (
  <Svg width="40px" height="40px" viewBox="0 0 40 40">
    <G id="Design" stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
      <G id="10.0---Schedule" transform="translate(-324.000000, -147.000000)">
        <G
          id="left-icon-copy"
          transform="translate(344.000000, 163.000000) scale(-1, 1) translate(-344.000000, -163.000000) translate(328.000000, 147.000000)"
        >
          <Rect
            id="Rectangle"
            fill="#FFFFFF"
